...
local Function entryDefinition()->$entry : cs:C1710.sfw_definitionEntry
	...
	$entry:=cs:C1710.sfw_definitionEntry.new("issuePriority"; "issue"; "Issue priorities")
	$entry.setDataclass("IssuePriority")
	$entry.setDisplayOrder(-3000)
	$entry.setIcon("image/entry/issuePriority-50x50.png")
