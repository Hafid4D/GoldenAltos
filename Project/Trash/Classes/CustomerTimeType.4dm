...
local Function entryDefinition()->$entry : cs:C1710.sfw_definitionEntry
	...
	$entry:=cs:C1710.sfw_definitionEntry.new("customerTimeType"; "time"; "Cust Time types")
	$entry.setDataclass("CustomerTimeType")
	$entry.setDisplayOrder(-7000)
	$entry.setIcon("image/entry/customerTimeType-50x50.png")
	$entry.setSearchboxField("code")
	$entry.setSearchboxField("name")
	$entry.setPanel("panel_customerTimeType")
	...
	$entry.setLBItemsCounter("###,###,##0 ^1;;"; "unit1:service type"; "unitN:customerTime types")
