...
// Purpose: Export current Financial Report list selection to Excel (skeleton mapping).
// Note: Method name kept <= 31 chars (4D limit); was _ga_exportFinancialReportSelection.
...
If (Form:C1466.sfw.lb_items.length>0)
	...
	$mapping:=New collection:C1472(New object:C1471("header"; "Report"; "field"; "reportName"; "footerOperation"; ""))
	...
	End if
	$destinationFolderPath:=Get 4D folder:C485(Current resources folder:K5:16)+"exportedData"+Folder separator:K24:12+"FinancialReport"
