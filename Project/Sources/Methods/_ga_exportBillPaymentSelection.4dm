...
// Purpose: Export current Bill Payment list selection to Excel (skeleton mapping).
...
If (Form:C1466.sfw.lb_items.length>0)
	...
	$mapping:=New collection:C1472(New object:C1471("header"; "Payment #"; "field"; "paymentNumber"; "footerOperation"; ""))
	...
	End if
	$destinationFolderPath:=Get 4D folder:C485(Current resources folder:K5:16)+"exportedData"+Folder separator:K24:12+"BillPayment"
