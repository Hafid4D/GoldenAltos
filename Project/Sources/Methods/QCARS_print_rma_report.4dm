...
If ($current_rma#Null:C1517)
	...
	$form:=New object:C1471(\
		"receivedDate"; $current_rma.receivedDate; \
	...
	Print form:C5([RMA:46]; "print_rma"; $form; Form header:K43:3)
	...
	Print form:C5([RMA:46]; "print_rma"; $form; Form detail:K43:1)
	
	$form:=New object:C1471()
	Print form:C5([RMA:46]; "print_rma"; $form; Form footer:K43:2)
