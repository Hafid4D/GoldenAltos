// Purpose: Panel controller for Bill Payment entry (typed legacy PartialPays fields).
...
// Purpose: Initialize panel state when opening a bill payment record.
// modified by 4D/PS [2026-june-29]
