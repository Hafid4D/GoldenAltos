// Purpose: Panel controller for Expense Transaction entry (typed legacy Internal BUY_ITEMS fields).
...
// Purpose: Initialize panel state when opening an expense record.
// modified by 4D/PS [2026-june-29]
