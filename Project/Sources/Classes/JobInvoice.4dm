...
local Function entryDefinition()->$entry : cs:C1710.sfw_definitionEntry
	...
	$entry.setSearchField("path:job.customerNameName"; "tag:Customer"; "popupPart:Job"; "placeholder:customerName"; "popupDescription:the customer name")
	...
	$entry.setLBItemsColumn("job.customerName"; "customer"; "width:100")
	...
	$view.setLBItemsColumn("job.customerName"; "customer"; "width:100")
