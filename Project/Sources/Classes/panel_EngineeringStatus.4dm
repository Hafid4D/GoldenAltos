...
Function redrawAndSetVisible()
	...
	This:C1470.drawPup_divisionItem()
	This:C1470.displayItemLine()
...
Function pup_divisionItem()
	...
	If (Form:C1466.sfw.checkIsInModification())
		...
		For each ($eDivision; Storage:C1525.cache.divisions)
			APPEND MENU ITEM:C411($menu; $eDivision.name; *)
			SET MENU ITEM PARAMETER:C1004($menu; -1; $eDivision.UUID)
			If ($eDivision.UUID=Form:C1466.selectedItem.UUID_Division)
				SET MENU ITEM MARK:C208($menu; -1; Char:C90(18))
				If (Is Windows:C1573)
					SET MENU ITEM STYLE:C425($menu; -1; Bold:K14:2)
				End if 
		...
		Case of 
			: ($choose#"")
				$eDivision:=ds:C1482.Division.get($choose)
				Form:C1466.selectedItem.UUID_Division:=$eDivision.UUID
		End case 
	End if 
	This:C1470.drawPup_divisionItem()
...
Function drawPup_divisionItem()
	//OBJECT SET VISIBLE(*; "pup_divisionItem"; Form.selectedItem#Null)
	If (Form:C1466.selectedItem#Null:C1517)
		$division:=ds:C1482.Division.query("UUID =:1"; Form:C1466.selectedItem.UUID_Division).first() || New object:C1471()
		$divisionName:=$division.name
		If ($divisionName=Null:C1517)
			$divisionName:=""
		End if 
		$color:=cs:C1710.sfw_htmlColor.me.getName($division.color)
		$pathIcon:=($color#"") ? "sfw/colors/"+$color+"-circle.png" : "sfw/image/skin/rainbow/icon/spacer-1x24.png"
		Form:C1466.sfw.drawButtonPup("pup_divisionItem"; $divisionName; $pathIcon; ($division=Null:C1517))
	End if 
	
Function displayItemLine()
	OBJECT SET VISIBLE:C603(*; "label_item@"; Not:C34((Form:C1466.selectedItem=Null:C1517)))
	OBJECT SET VISIBLE:C603(*; "entryField_item@"; Not:C34((Form:C1466.selectedItem=Null:C1517)))
	OBJECT SET VISIBLE:C603(*; "pup_divisionItem"; Form:C1466.selectedItem#Null:C1517)
